...
class OperationItem01_02SkeletonCantUndo : OperationItemDataBaseCantUndo() {
    ...
    inner class Instance : OperationItemBase() {
        ...
        override fun doOperation(instance: SingleOperationManagerPrivate, completion: (OperationItemDataBase) -> Unit) {
            instance.doOperation(OperationItem02SkeletonCantUndo(), {
                Log.i(TAG, "doOperation() finished. ${this@OperationItem01_02SkeletonCantUndo.javaClass.simpleName}")
                completion.invoke(this@OperationItem01_02SkeletonCantUndo)
            })
        }
    }
}
