...
class OperationItem01_01SkeletonCantUndo : OperationItemDataBaseCantUndo() {
    ...
    inner class Instance : OperationItemBase() {
        ...
        override fun doOperation(instance: SingleOperationManagerPrivate, completion: (OperationItemDataBase) -> Unit) {
            Log.i(TAG, "doOperation() finished. ${this@OperationItem01_01SkeletonCantUndo.javaClass.simpleName}")
            completion.invoke(this@OperationItem01_01SkeletonCantUndo)
        }
    }
}
