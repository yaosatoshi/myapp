...
class OperationItem02SkeletonCanUndo : OperationItemDataBaseCanUndo() {
    ...
    inner class Instance : OperationItemBase() {
        ...
        override fun doOperation(instance: SingleOperationManagerPrivate, completion: (OperationItemDataBase) -> Unit) {
            Log.i(TAG, "doOperation() finished. ${this@OperationItem02SkeletonCanUndo.javaClass.simpleName}")
            completion.invoke(this@OperationItem02SkeletonCanUndo)
        }
    }
}
